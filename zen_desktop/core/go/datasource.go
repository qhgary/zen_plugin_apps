...
type DataSourceConfig struct {
	...
	ZenConfig map[string]interface{}    `json:"zenConfig,omitempty"`
}
...
// SetZenConfig 更新缠论配置并持久化
func SetZenConfig(cfg map[string]interface{}) {
	configMu.Lock()
	defer configMu.Unlock()
	if currentConfig == nil {
		return
	}
	currentConfig.ZenConfig = cfg
	saveConfig()
}
...
func GetZenConfig() map[string]interface{} {
	...
	return currentConfig.ZenConfig
}
