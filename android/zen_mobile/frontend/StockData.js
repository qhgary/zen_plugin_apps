...
class StockData {
    ...
    NetworkFilter(data, callback, option) {
        ...
        switch (data.Name) {
            ...
            case "JSTReportChartContainer::RequestStockListData":
                this.TReport_RequestStockListData(data, callback, option);
                break;
    ...
    Report_RequestStockData(data, callback, option) {
        var aryStock = data.Request.Data.stocks;
    ...
    KLine_RequestPreviousDayData(data, callback, option) {
        data.PreventDefault = true;
        var symbol = data.Request.Data.symbol;
        var right = data.Request.Right;
        var period = data.Request.Period;
        var count = data.Request.Data.count;
        var endDate = data.Request.Data.enddate;
        ...
        var reqInfoDay = { Symbol: symbol, Period: period, Right: right, History: true, Seq: reqSeq };
        ...
        var callbackInfo =
        {
            ...
            ExtendID: extendID,
            Callback: (recv) => {
                this.KLine_RecvHistoryData(recv, callback, option, reqInfoDay);
            }
        }
    ...
    KLine_RequestPreviousMinuteData(data, callback, option) {
        ...
        var count = data.Request.Data.count;
        var endDate = data.Request.Data.enddate;
        var endTime = data.Request.Data.endtime;
        ...
        var reqInfoMinute = { Symbol: symbol, Period: period, Right: right, History: true, Seq: reqSeq };
        ...
        var callbackInfo =
        {
            ...
            ExtendID: extendID,
            Callback: (recv) => {
                this.KLine_RecvHistoryData(recv, callback, option, reqInfoMinute);
            }
        }
